...
# python3 workload_generator.py --num_request 10 --url http://localhost:5000/ --image_folder face_images_1000 --prediction_file 'Classification Results on Face Dataset (1000 images).csv'
...
while True:
    ...
    if num_request == (responses + err_responses) or test_duration > 5:
